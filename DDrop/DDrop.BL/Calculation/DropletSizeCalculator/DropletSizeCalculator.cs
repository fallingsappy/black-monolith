...
namespace DDrop.BL.Calculation.DropletSizeCalculator
{
    ...
    {
        public static void PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, Series CurrentSerries, DropPhoto dropPhoto, int zDiameterInPixels = 0, bool exactCalculationModel = false)
        {
        ...
        private static void PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, Series CurrentSerries, DropPhoto dropPhoto)
        {
        ...
        private static void PerformExactCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, int zDiameterInPixels, Series CurrentSerries, DropPhoto dropPhoto)
        {
            dropPhoto.Drop.XDiameterInMeters = xDiameterInPixels / (double)pixelsInMillimeter / 1000;
            dropPhoto.Drop.YDiameterInMeters = yDiameterInPixels / (double)pixelsInMillimeter / 1000;
