...
namespace DDrop.BL.Calculation.DropletSizeCalculator
{
    ...
    {
        public static void PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, BE.Models.DropPhoto dropPhoto, int zDiameterInPixels = 0, bool exactCalculationModel = false)
        {
            if (exactCalculationModel)
            {
                PerformExactCalculation(pixelsInMillimeter, xDiameterInPixels, yDiameterInPixels, zDiameterInPixels, dropPhoto);
            }
            else
            {
        ...
        private static void PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, BE.Models.DropPhoto dropPhoto)
        {
        ...
        private static void PerformExactCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, int zDiameterInPixels, BE.Models.DropPhoto dropPhoto)
        {
            dropPhoto.Drop.XDiameterInMeters = xDiameterInPixels / (double)pixelsInMillimeter / 1000;
            dropPhoto.Drop.YDiameterInMeters = yDiameterInPixels / (double)pixelsInMillimeter / 1000;
