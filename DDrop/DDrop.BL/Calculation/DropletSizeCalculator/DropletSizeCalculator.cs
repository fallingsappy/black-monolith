...
namespace DDrop.BL.Calculation.DropletSizeCalculator
{
    ...
    {
        public static Drop PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, int zDiameterInPixels = 0, bool exactCalculationModel = false)
        {
            if (exactCalculationModel)
            {
                return PerformExactCalculation(pixelsInMillimeter, xDiameterInPixels, yDiameterInPixels, zDiameterInPixels);
            }
            else
            {
                return PerformCalculation(pixelsInMillimeter, xDiameterInPixels, yDiameterInPixels);
            }
        }

        private static Drop PerformCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels)
        {
        ...
        private static Drop PerformExactCalculation(int pixelsInMillimeter, int xDiameterInPixels, int yDiameterInPixels, int zDiameterInPixels)
        {
            double xDiameterInMeters = xDiameterInPixels / (double)pixelsInMillimeter / 1000;
            double yDiameterInMeters = yDiameterInPixels / (double)pixelsInMillimeter / 1000;
