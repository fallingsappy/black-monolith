...
namespace DDrop.Controls.LoadingSpinner
{
    public class AdornedControl : ContentControl
    {
        ...
        public static readonly RoutedCommand ShowAdornerCommand =
            new RoutedCommand("ShowAdorner", typeof(AdornedControl));

        public static readonly RoutedCommand HideAdornerCommand =
            new RoutedCommand("HideAdorner", typeof(AdornedControl));
        ...
        private void ShowAdornerInternal()
        {
            ...
            {
                if (adornerLayer == null) adornerLayer = AdornerLayer.GetAdornerLayer(this);

                if (adornerLayer != null)
                {
                    adorner = new FrameworkElementAdorner(AdornerContent, this, HorizontalAdornerPlacement,
